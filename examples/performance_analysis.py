...
analyzer.example_plots(P_thresh_opt,'test',['TP'],max_plot=1,extra_filename='testtp',normalize=normalize)
#analyzer.example_plots(P_thresh_opt,'test',['late'],extra_filename='testlate',normalize=normalize)

analyzer.example_plots(P_thresh_opt,'train',['TN'],max_plot=1,extra_filename='traintn',normalize=normalize)
